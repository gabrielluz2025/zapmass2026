...
export function normBlumenauNbKey(s) {
    return String(s || '')
        .normalize('NFD')
        .replace(/\p{M}/gu, '')
        .toLowerCase()
...
export const BLUMENAU_NB_ALIASES = {
...
export function matchOfficialNeighborhood(raw) {
...
export function blumenauSpreadCoord(index, total = BLUMENAU_OFFICIAL_NEIGHBORHOODS.length) {
