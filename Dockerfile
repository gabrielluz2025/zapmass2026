...
ARG VITE_USE_VPS_AUTH=""
ARG VITE_USE_VPS_DATA=""
ARG VITE_ZAPMASS_ENV=""
ENV VITE_ADMIN_EMAILS=$VITE_ADMIN_EMAILS \
    VITE_ADMIN_UIDS=$VITE_ADMIN_UIDS \
    VITE_ZAPMASS_ADMIN_UIDS=$VITE_ZAPMASS_ADMIN_UIDS \
    ...
    VITE_USE_VPS_AUTH=$VITE_USE_VPS_AUTH \
    VITE_USE_VPS_DATA=$VITE_USE_VPS_DATA \
    VITE_ZAPMASS_ENV=$VITE_ZAPMASS_ENV
...
COPY --from=builder /app/scripts/classify-pending-reply-intents.ts ./scripts/classify-pending-reply-intents.ts
