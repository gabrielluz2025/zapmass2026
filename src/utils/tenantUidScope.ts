...
/** Namespace fixo ZapMass — UUID v5 estável por UID Firebase (igual ao servidor). */
...
/** RFC 4122 UUID v5 — mesmo firebaseUid → sempre o mesmo UUID Postgres derivado. */
...
/** Todas as formas equivalentes do tenant (Firebase legado + UUID Postgres derivado). */
