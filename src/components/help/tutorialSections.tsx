    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: '📱', text: 'Prévia no celular ao editar cada passo (texto, foto e link)' },
          { icon: '👥', text: 'Aba Inscritos: quem está ativo, interagindo ou pausado — com nome do CRM' },
          { icon: '🚀', text: 'Aba Enviar: inscrever uma pessoa ou disparar passo atual para todos/selecionados' },
