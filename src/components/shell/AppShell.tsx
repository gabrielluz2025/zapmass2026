...
export const AppShell: React.FC<AppShellProps> = ({
  ...
  return (
    <div className="min-h-screen flex zm-aurora-root">
      ...
      */}
      <main
        className={`flex-1 min-w-0 ${sidebarOffset} overflow-y-auto overflow-x-hidden h-screen flex flex-col transition-[margin-left] duration-200 ease-in-out motion-reduce:transition-none zm-aurora-main`}
      >
        <TopBar
          currentView={currentView}
