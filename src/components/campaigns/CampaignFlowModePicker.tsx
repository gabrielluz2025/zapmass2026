...
import { ChevronDown, GitBranch, ListOrdered } from 'lucide-react';

export type CampaignFlowMode = 'sequential' | 'reply';
...
export const CampaignFlowModePicker: React.FC<Props> = ({ mode, onChange }) => (
  <div className="cw-msg-section">
    ...
    <div className="cw-flow-segment" role="group" aria-label="Modo das etapas">
      <button
        type="button"
      ...
      >
        ...
        <span>
          ...
          <span className="block text-[11px] mt-0.5 leading-snug" style={{ color: 'var(--text-3)' }}>
            Todas as etapas em fila, sem esperar resposta.
          </span>
        </span>
      </button>
    </div>
