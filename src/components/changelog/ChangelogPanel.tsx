...
interface ChangelogEntry {
  version: string;
  date: string;
  highlights: { type: 'fix' | 'feat' | 'feature' | 'improvement' | 'perf' | 'security'; text: string }[];
}
...
const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: '24/09/2026',
    highlights: [
      { type: 'fix', text: 'Purge fila campanha: confirmação via ZAPMASS_PURGE_CONFIRM na VPS' },
    ],
  },
  {
    version: '2.3.186',
  ...
  },
  {
    ...
    date: '24/09/2026',
    highlights: [
      { type: 'fix', text: 'Diagnóstico Go: resumo multi-chip e pick com JID/webhook' },
    ],
  },
  {
    version: '2.3.180',
  ...
  },
  {
    ...
    date: '11/09/2026',
    highlights: [
      { type: 'improvement', text: 'Soft-ban: circuit breaker THROTTLED por queda de ACK de entrega' },
    ],
  },
  {
    version: '2.3.123',
  ...
  },
  {
    ...
    date: '10/09/2026',
    highlights: [
      { type: 'fix', text: 'Importação por planilha não some mais; notebook/desktop/equipe recebem contatos e listas em tempo real' },
    ],
  },
  {
    version: '2.3.116',
  ...
  },
  {
    ...
    date: '09/09/2026',
    highlights: [
      { type: 'fix', text: 'validate-post-deploy: ambiente Go não acusa mais falha falsa na Evolution API :8080' },
    ],
  },
  {
    version: '2.3.99',
...
const typeConfig = {
  ...
  feature: { icon: Sparkles, label: 'Novidade', color: 'text-emerald-600 dark:text-emerald-400', bg: 'bg-emerald-500/10 border-emerald-500/20' },
  improvement: { icon: Sparkles, label: 'Melhoria', color: 'text-violet-600 dark:text-violet-400', bg: 'bg-violet-500/10 border-violet-500/20' },
