          ...
          <div className="p-4">
            ...
            <div className="grid grid-cols-3 gap-1.5 mb-3">
              {[
                ...
                { label: 'Concluídas', val: fleetSummary.completed, color: '#06B6D4' }
              ].map((k) => (
                <div
                  key={k.label}
        ...
        <Card className="zm-intel-card zm-send-trend-card xl:col-span-4 p-0 flex flex-col overflow-hidden">
          ...
          <div className="p-4 flex flex-col flex-1 min-h-0">
            ...
            {!weekHasData ? (
              ...
              >
                <Activity className="w-8 h-8 mb-2 opacity-25" style={{ color: '#06B6D4' }} />
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-center leading-tight">
                        <span
                          className={`block text-[10px] font-bold tabular-nums ${meta.isToday ? ' /**
 * Novos blocos do painel: radar de campanhas, saúde dos chips, alertas CRM,
 * envios últimos 7 dias, score da base, feed de atividade e meta mensal.
 */
import React, { useDeferredValue, useMemo, useState } from 'react';
                ...
                {series7.map((s, barIdx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-center leading-tight">
                        <span
                          className={`block text-[10px] font-bold tabular-nums ${meta.isToday ? 'text-cyan-400' : ''}`}
