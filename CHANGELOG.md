...
- **Chip offline na fila**: se outro chip selecionado está online, o job troca de canal em vez de esperar 60s no chip caído.
...
## [2.3.177] - 2026-09-24
### Corrigido
- **CI**: typecheck em replyIntent (Contact import, Conversation, blacklist).
...
## [2.3.125] - 2026-09-11
### Melhorado
- **Anti-ban (Item 3)**: `campaignMediaMutator` muta imagens (sharp/EXIF), áudio (ID3/padding) e vídeo (atom MP4) após N usos do mesmo SHA256; `validateCampaignMediaHash` estende o content hash lock para mídia no worker BullMQ.
